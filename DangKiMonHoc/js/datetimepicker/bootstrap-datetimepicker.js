...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		this.icons = {
		    leftArrow: this.fontAwesome ? 'fa fa-long-arrow-left' : (this.bootcssVer === 3 ? 'fa fa-long-arrow-left' : 'fa fa-long-arrow-left'),
		    rightArrow: this.fontAwesome ? 'fa fa-long-arrow-right' : (this.bootcssVer === 3 ? 'fa fa-long-arrow-right' : 'fa fa-long-arrow-right')
		};
